...
class Ion_auth
{
	 ...
	 * __call
	 *
	 * Acts as a simple way to call models methods without loads of stupid alias'
	 *
	 **/
	...
	public function forgotten_password($identity)    //changed $email to $identity
	{
      ...
      $identifier = $this->ion_auth_model->identity_column; // use models identity column, so it can be overridden in a controller
