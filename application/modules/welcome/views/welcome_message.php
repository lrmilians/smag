...
<div id="container">
	...
	<div id="body">
		...
		<ul>
			<li><a href="<?php echo site_url('api/example/users/format/xml');?>">Users</a> - defaulting to XML</li>
			<li><a href="<?php echo site_url('api/example/users/format/csv');?>">Users</a> - get it in CSV</li>
			<li><a href="<?php echo site_url('api/example/user/id/1/format/xml');?>">User #1</a> - defaulting to XML</li>
