 ...
 *
 * Defining an ActiveRecord models for a table called people and orders:
 *
 * <code>
 * CREATE TABLE people(
...
class Model
{
	...
	/**
	 * Contains models values as column_name => value
	 *
	 * @var array
	 */
	...
	/**
	 * Flag whether or not this models's attributes have been modified since it will either be null or an array of column_names that have been modified
	 *
	 * @var array
	 */
	...
	/**
	 * Flag that determines of this models can have a writer method invoked such as: save/update/insert/delete
	 *
	 * @var boolean
	 */
	...
	/**
	 * Set this to explicitly specify the models's table name if different from inferred name.
	 *
	...
	/**
	 * Whitelist of attributes that are checked from mass-assignment calls such as constructing a models or using update_attributes.
	 *
	 ...
	 * </code>
	 *
	 * @param array $attributes Hash containing names and values to mass assign to the models
	 * @param boolean $guard_attributes Set to true to guard protected/non-accessible attributes
	 * @param boolean $instantiating_via_find Set to true if this models is being created from a find call
	 ...
	 *
	 * You can also define customer getter methods for the models.
	 *
	 * EXAMPLE:
	 * <code>
	 ...
	 *
	 * You can also define customer setter methods for the models.
	 *
	 * EXAMPLE:
	 * <code>
	 * class User extends ActiveRecord\Model {
	...
	public function assign_attribute($name, $value)
	{
		...
		// make sure DateTime values know what models they belong to so
	 ...
	 * accessed is 'id' then it will return the models's primary key no matter what the actual attribute name is
	 * for the primary key.
	 *
	 * @param string $name Name of an attribute
	 * @return mixed The value of the attribute
	...
	/**
	 * Returns hash of attributes that have been modified since loading the models.
	 *
	...
	/**
	 * Check if a particular attribute has been modified since loading the models.
	...
	/**
	 * Returns a copy of the models's attributes hash.
	 *
	 * @return array A copy of the models's attribute data
	 */
	 ...
	 * @return string The primary key for the models
	 */
	 ...
	 * </code>
	 *
	 * @return array An array containing validator data for this models.
	 */
	...
	/**
	 * Determine if the models is in read-only mode.
	 *
	 * @return boolean
	 */
	...
	/**
	 * Determine if the models is a new record.
	 *
	 * @return boolean
	 */
	...
	/**
	 * Throws an exception if this models is set to readonly.
	 *
	 * @throws ActiveRecord\ReadOnlyException
	 * @param string $method_name Name of method that was invoked on models for exception message
	 */
	...
	/**
	 * Flag models as readonly.
	 *
	 * @param boolean $readonly Set to true to put the models into readonly mode
	 */
	...
	/**
	 * Retrieve the connection for this models.
	 *
	 * @return Connection
	 */
	...
	/**
	 * Returns the {@link Table} object for this models.
	 *
	...
	/**
	 * Creates a models and saves it to the database.
	 *
	 ...
	 * If a validation or a callback for this models returns false, then the models will
	 * not be saved and this will return false.
	 *
	 * If saving an existing models only data that has changed will be saved.
	 *
	 * @param boolean $validate Set to true or false depending on if you want the validators to run or not
	 * @return boolean True if the models was saved to the database otherwise false
	 */
	...
	/**
	 * Issue an INSERT sql statement for this models's attribute.
	 *
	 * @see save
	 * @param boolean $validate Set to true or false depending on if you want the validators to run or not
	 * @return boolean True if the models was saved to the database otherwise false
	...
	/**
	 * Issue an UPDATE sql statement for this models's dirty attributes.
	 *
	 * @see save
	 * @param boolean $validate Set to true or false depending on if you want the validators to run or not
	 * @return boolean True if the models was saved to the database otherwise false
	...
	/**
	 * Deletes this models from the database and returns true if successful.
	 *
	 * @return boolean
	 */
	...
	/**
	 * Returns true if the models has been modified.
	 *
	...
	/**
	 * Run validations on models and returns whether or not models passed validation.
	 *
	 * @see is_invalid
	 * @return boolean
	 */
	...
	/**
	 * Mass update the models with an array of attribute data and saves to the database.
	 *
	...
	/**
	 * Mass update the models with data from an attributes hash.
	 *
	 * Unlike update_attributes() this method only updates the models's data
	...
	/**
	 * Add a models to the given named ($name) relationship.
	 *
	...
	public function set_relationship_from_eager_load(Model $model=null, $name)
	{
		...
		if (($rel = $table->get_relationship($name)))
		{
			if ($rel->is_poly())
			{
				// if the related models is null and it is a poly then we should have an empty array
				if (is_null($model))
	 ...
	 * </code>
	 *
	 * You can also create the models if the find call returned no results:
	 *
	 * <code>
	 ...
	 *
	 * <code>
	 * # queries for the models with id=123
	 * YourModel::find(123);
	 *
	 * # queries for models with id in(1,2,3)
	 ...
	 * <li><b>joins:</b> A SQL join fragment such as: 'JOIN roles ON(roles.user_id=user.id)' or a named association on the models</li>
	...
	/**
	 * Finder method which will find by a single or array of primary keys for this models.
	 *
	 * @see find
	...
	/**
	 * Helper method to run arbitrary queries against the models's database connection.
	 *
   ...
   /**
   * Returns an CSV representation of this models.
   ...
   * @return string CSV representation of the models
   */
  public function to_csv(array $options=array())
  {
	...
	/**
	 * Returns an Array representation of this models.
	 *
	 * @see Serialization
	 * @param array $options An array containing options for json serialization (see {@link Serialization} for valid options)
	 * @return array Array representation of the models
	 */
	 ...
	 * @return string Serialized representation of the models
	 */
	...
	/**
	 * Invokes the specified callback on this models.
	 *
