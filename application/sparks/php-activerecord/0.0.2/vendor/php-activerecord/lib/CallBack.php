 ...
 * Valid callbacks are:
 * <ul>
 * <li><b>after_construct:</b> called after a models has been constructed</li>
 * <li><b>before_save:</b> called before a models is saved</li>
 * <li><b>after_save:</b> called after a models is saved</li>
 * <li><b>before_create:</b> called before a NEW models is to be inserted into the database</li>
 * <li><b>after_create:</b> called after a NEW models has been inserted into the database</li>
 * <li><b>before_update:</b> called before an existing models has been saved</li>
 * <li><b>after_update:</b> called after an existing models has been saved</li>
 * <li><b>before_validation:</b> called before running validators</li>
 * <li><b>after_validation:</b> called after running validators</li>
 * <li><b>before_validation_on_create:</b> called before validation on a NEW models being inserted</li>
 * <li><b>after_validation_on_create:</b> called after validation on a NEW models being inserted</li>
 * <li><b>before_validation_on_update:</b> see above except for an existing models being saved</li>
 * <li><b>after_validation_on_update:</b> ...</li>
 * <li><b>before_destroy:</b> called after a models has been deleted</li>
 * <li><b>after_destroy:</b> called after a models has been deleted</li>
 * </ul>
 *
 * This class isn't meant to be used directly. Callbacks are defined on your models like the example below:
 *
 * <code>
...
class CallBack
{
	...
	/**
	 * Container for reflection class of given models
	 *
	 * @var object
	 */
	private $klass;
	...
	/**
	 * List of public methods of the given models
	 * @var array
	 */
	 ...
	 * models object. For (after|before)_(create|update) callbacks, it will merge with
