...
class Validations
{
	 ...
	 *
	 * @param Model $model The models to validate
	 * @return Validations
	 */
...
class Errors implements IteratorAggregate
{
	 ...
	 *
	 * @param Model $model The models the error is for
	 * @return Errors
	 */
	public function __construct(Model $model)
	{
	...
	/**
	 * Nulls $models so we don't get pesky circular references. $models is only needed during the
	 ...
	 *
	 * @param string $attribute Name of an attribute on the models
