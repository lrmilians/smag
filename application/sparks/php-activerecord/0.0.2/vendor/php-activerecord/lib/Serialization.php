 ...
 * $models->to_xml(array('except' => 'password')));
 * </code>
 *
 * @package ActiveRecord
...
abstract class Serialization
{
	 ...
	 *
	 * @param Model $model The models to serialize
